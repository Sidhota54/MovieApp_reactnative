...
const PersonScreen = () => {
    ...
    return (
        <ScrollView className='flex-1 bg-neutral-900  ' contentContainerStyle={{ paddingBottom: 20, minWidth: width, minHeight: height }}>
            <SafeAreaView className={` ${topMargin} absolute top-0  z-20 w-full flex-row justify-between items-center px-4 ${verticalMargin}`}>
                ...
                {!loading && <TouchableOpacity onPress={() => toggleFavourite(!isFavourite)}>
            ...
            {loading ? (<Loading />) : (
                <View>
                    <View className='flex-row rounded-full justify-center  mt-16'
                        style={{
                            shadowColor: 'white',
                            shadowRadius: 70,
                    ...
                    <View className='mt-6'>
                        ...
                        <Text className='text-base text-neutral-300  text-center'>{person?.place_of_birth}</Text>
                    </View>
